...
$user = 'galoremag'; // place SG username here
$pass = 'G@lor3mag!'; // place SG password here
...
$params = array(
    'api_user'  => "$user",
    'api_key'   => "$pass",
    'to'        => "aaronsmulktis@gmail.com", // set TO address to have the contact form's email content sent to
...
header('Location: http://galoremag.com/kitten'); // feel free to use whatever title you wish for thank you landing page, but will need to reference that file name in place of the present 'thanks.html'
exit();
